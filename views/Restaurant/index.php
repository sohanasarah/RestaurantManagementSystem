    ...
    <div class="row">
      <div class="grid_4">
        <div class="banner">
          ...
          <img src="../../resource/images/page1_img1.jpg" alt="">
          <div class="bann_capt ">
            <div class="maxheight">
              <img src="../../resource/images/icon1.png" alt="">
      ...
      <div class="grid_4">
        <div class="banner">
          ...
          <div class="bann_capt  bn__1">
            <div class="maxheight">
              <img src="../../resource/images/icon2.png" alt="">
              <div class="bann_title">Kid’s &amp; Vegan Menu</div>
              <a href="#">more</a>
            </div>
          </div>
          <img src="../../resource/images/page1_img2.jpg" alt="">
        </div>
		</div>
      </div>
      <div class="grid_4">
        <div class="banner ">
		  <div class="gall_block">
          <img src="../../resource/images/page1_img3.jpg" alt="">
          <div class="bann_capt  bn__2">
            <div class="maxheight">
              <img src="../../resource/images/icon3.png" alt="">
      ...
      <div class="gallery">
        <div class="grid_4"><a href="../../resource/images/big1.jpg" class="gall_item"><img src="../../resource/images/page1_img4.jpg" alt=""></a><a href="#" class="link1">+</a><div class="clear"></div></div>
        <div class="grid_4"><a href="../../resource/images/big2.jpg" class="gall_item"><img src="../../resource/images/page1_img5.jpg" alt=""></a><a href="#" class="link1">+</a><div class="clear"></div></div>
        <div class="grid_4"><a href="../../resource/images/big3.jpg" class="gall_item"><img src="../../resource/images/page1_img6.jpg" alt=""></a><a href="#" class="link1">+</a><div class="clear"></div></div>
      </div>
      <div class="grid_4">
        <h2>Testimonials</h2>
        <blockquote class="bq1">
          <img src="../../resource/images/page1_img7.jpg" alt="" class="img_inner fleft noresize">
